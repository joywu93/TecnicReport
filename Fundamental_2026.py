...
def get_realtime_price(code, default_price):
    ...
    # 🛡️ 萬一即時雷達全部失效，優雅地返回 Google Sheet 裡的舊價格，絕對不當機！
...
# 🌟 核心快取大腦 
# ==========================================
@st.cache_data(ttl=3600, show_spinner="連線至雙核大數據庫 (V183 強制突破版)...")
